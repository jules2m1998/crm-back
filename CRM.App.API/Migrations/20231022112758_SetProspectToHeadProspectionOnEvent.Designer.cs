...
namespace CRM.App.API.Migrations
{
    ...
    [Migration("20231022112758_SetProspectToHeadProspectionOnEvent")]
    partial class SetProspectToHeadProspectionOnEvent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CRM.Core.Domain.Entities.HeadProspection", b =>
                {
                    ...
                    b.HasKey("AgentId", "ProductId", "CompanyId");
            ...
            modelBuilder.Entity("CRM.Core.Domain.Entities.Event", b =>
                {
                    ...
                    b.HasOne("CRM.Core.Domain.Entities.HeadProspection", "Prospect")
                        .WithMany()
                        .HasForeignKey("AgentId", "ProductId", "CompanyId")
            ...
            modelBuilder.Entity("CRM.Core.Domain.Entities.StageResponse", b =>
                {
                    ...
                    b.HasOne("CRM.Core.Domain.Entities.ProductStage", "NextStage")
                        .WithMany()
